...
public interface ConstCurd {
	 ...
	 * 上传成功
	 */
	final static String UPLOAD_SUCCESS_MSG = "上传成功！";
	
	/**
	 * 上传失败
	 */
	final static String UPLOAD_FAIL_MSG = "上传失败！";
	 ...
	 * 操作成功
	 */
	final static String OP_SUCCESS_MSG = "操作成功！";

	/**
	 * 操作失败
	 */
	final static String OP_FAIL_MSG = "操作失败！";

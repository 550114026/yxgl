	...
	@ 	token = "";	
	@}
	<input type="text" id="_${x.index!}" onfocus="this.blur()" name="${token}${table!x.table}.${x.index!}" ${x.required!} ${x.disabled!}  value="${x.value!}" placeholder="请输入${x.name!}" data-date-format="yyyy-mm-dd" class="form-control" />

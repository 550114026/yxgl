...
public class CustomServiceApi {
    ...
    private static ApiResult sendMsg(Map<String, Object> message) {
        ...
        String jsonResult = HttpUtils.post(customMessageUrl + accessToken, json);
        return new ApiResult(jsonResult);
    }
     ...
     * @return
     */
    public static ApiResult sendEmpty(){
    	return sendMsg(null);
    }
     ...
     * @return ApiResult
     */
    public static ApiResult sendText(String openId, String text, String kf_account) {
        Map<String, Object> json = new HashMap<String, Object>();
        json.put("touser", openId);
        json.put("msgtype", "text");
        ...
        if(StringUtils.isNotBlank(kf_account)){
	        Map<String, Object> customserviceObj = new HashMap<String, Object>();
	        customserviceObj.put("kf_account", kf_account);
	        json.put("customservice", customserviceObj);
        }
